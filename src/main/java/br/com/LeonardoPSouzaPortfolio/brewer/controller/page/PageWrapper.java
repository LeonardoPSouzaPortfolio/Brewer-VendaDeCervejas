package br.com.LeonardoPSouzaPortfolio.brewer.controller.page;
...
public class PageWrapper<T> {
	...
	public PageWrapper(Page<T> page, HttpServletRequest httpServletRequest) {
		this.page = page;
		//this.uriBuilder = ServletUriComponentsBuilder.fromRequest(httpServletRequest); // Problemas com espaço na pesquisa
